...
<?php
	...
	$segments = explode('/', trim(parse_url($_SERVER['https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/weatherdata/history'], PHP_URL_PATH), '/'));
	$query_str = parse_url($_SERVER['https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/weatherdata/history'], PHP_URL_QUERY);
	...
	$aggregateHours=24;
	$apiKey="d5fb326ed9mshe394b66d2f61ec9p111228jsnbb4bbf3816fa";
?>
